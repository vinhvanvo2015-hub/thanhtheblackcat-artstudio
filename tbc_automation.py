...
RAW_PINATA_JWT = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..EqedzH9z7kLRpy8lu2KVL21-_zH4DoR3SucXkKQh_WU"
PINATA_JWT_TOKEN = "".join(RAW_PINATA_JWT.split())
...
class ArtworkPipelineHandler(FileSystemEventHandler):
    ...
    def upload_to_pinata_ipfs(self, image_path, artwork_id):
        ...
        headers = {"Authorization": f"Bearer {PINATA_JWT_TOKEN.strip()}"}
